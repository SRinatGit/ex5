...
public class ProductRegister {
   @Id
   @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "product_register_seq")
   @SequenceGenerator(name = "product_register_seq", sequenceName = "seq_id", allocationSize = 1)
   @Column(name = "id", nullable = false)
   private long id;
   @OneToOne(cascade = {CascadeType.DETACH})
   @JoinColumn(name = "type", referencedColumnName = "register_type_name")
